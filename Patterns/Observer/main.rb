...
require_relative 'age_auditor'

NUM_OF_RUNS = 8

oracle = Oracle.new
auditor = Auditor.new
age_auditor = AgeAuditor.new

# evaluate random strategy
total_num_attempts = 0
total_num_failures = 0
homer = Participant.new(oracle,'homer', max_num_attempts: NUM_OF_RUNS*2)
homer.add_observer(auditor)
homer.add_observer(age_auditor)
...
total_num_attempts = 0
total_num_failures = 0
bart = Participant.new(oracle,'bart', max_num_attempts:NUM_OF_RUNS*2)
bart.add_observer(auditor)
bart.add_observer(age_auditor)
...
total_num_attempts = 0
total_num_failures = 0
maggie = Participant.new(oracle,'maggie', max_num_attempts:NUM_OF_RUNS*5)
maggie.add_observer(auditor)
maggie.add_observer(age_auditor)
...
total_num_attempts = 0
total_num_failures = 0
lisa = Participant.new(oracle,'lisa', max_num_attempts:NUM_OF_RUNS*5)
lisa.add_observer(auditor)
lisa.add_observer(age_auditor)
